...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" style="margin-top: 10%; width:566px">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\laravel11-crash-course\resources\views/auth/login.blade.php ENDPATH**/ ?>